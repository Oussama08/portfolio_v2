      ...
      var r,
        ...
        E = function (t) {
          var n = "clientWidth",
            ...
            g = new Date().getTime();
          if (t && r && p > g - r)
            return e.clearTimeout(o), void (o = e.setTimeout(E, p));
          r = g;
          for (var w in h)
          ...
          for (var R in i)
            if (i.hasOwnProperty(R)) {
              ...
              (O.type = "text/css"),
                ...
                O.styleSheet
                  ? (O.styleSheet.cssText = k)
                  : O.appendChild(m.createTextNode(k)),
                c.push(O);
            }
        },
        w = function (e, t, a) {
          ...
          for (var l = 0; i > l; l++) {
            ...
            o
              ? ((m = a), u.push(r(e)))
              : ((m = s[l].match(n.regex.findStyles) && RegExp.$1),
            ...
            for (var p = 0; f > p; p++)
              (d = c[p]),
                h.push({
                  media:
                    (d.split("(")[0].match(n.regex.only) && RegExp.$2) || "all",
                  rules: u.length - 1,
                  hasquery: d.indexOf("(") > -1,
                  minw:
                    d.match(n.regex.minw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                  maxw:
                    d.match(n.regex.maxw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                });
          }
          E();
          ...
          for (var t = 0; t < x.length; t++) {
            ...
            s &&
              ...
              (n.styleSheet && n.styleSheet.rawCssText
                ? (w(n.styleSheet.rawCssText, s, i), (f[s] = !0))
                : ((!/^([a-zA-Z:]*\/\/)/.test(s) && !g) ||
                    s.replace(RegExp.$1, "").split("/")[0] ===
                      e.location.host) &&
                  ("//" === s.substring(0, 2) && (s = e.location.protocol + s),
                  a.push({ href: s, media: i })));
          }
          S();
        };
      T(),
